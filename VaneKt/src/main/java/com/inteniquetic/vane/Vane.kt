   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.INSTANCE.ffi_vane_rustbuffer_free(buf, status)
        }
    }
...
fun uniffi_vane_checksum_func_create_json_body(
): Short
...
fun uniffi_vane_fn_func_create_json_body(`jsonString`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun uniffi_vane_fn_func_create_vane_client(`config`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Pointer
fun uniffi_vane_fn_func_parse_json_response(`response`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    if (lib.uniffi_vane_checksum_func_create_default_config() != 49144.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vane_checksum_func_create_json_body() != 8961.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vane_checksum_func_create_vane_client() != 5446.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vane_checksum_func_parse_json_response() != 5128.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vane_checksum_method_vaneclient_delete_request() != 45729.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vane_checksum_method_vaneclient_execute_request() != 8112.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vane_checksum_method_vaneclient_get_request() != 21832.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vane_checksum_method_vaneclient_patch_request() != 24408.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vane_checksum_method_vaneclient_post_request() != 19003.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_vane_checksum_method_vaneclient_put_request() != 51033.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
public interface VaneClientInterface {
    ...
    fun `patchRequest`(`url`: kotlin.String, `body`: kotlin.String?): VaneResponse
    
    fun `postRequest`(`url`: kotlin.String, `body`: kotlin.String?): VaneResponse
    
    fun `putRequest`(`url`: kotlin.String, `body`: kotlin.String?): VaneResponse
...
open class VaneClient: Disposable, AutoCloseable, VaneClientInterface
{
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_vane_fn_free_vaneclient(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_vane_fn_clone_vaneclient(pointer!!, status)
        }
    }
    ...
    @Throws(VaneException::class)override fun `patchRequest`(`url`: kotlin.String, `body`: kotlin.String?): VaneResponse {
            return FfiConverterTypeVaneResponse.lift(
    callWithPointer {
    uniffiRustCallWithError(VaneException) { _status ->
    UniffiLib.INSTANCE.uniffi_vane_fn_method_vaneclient_patch_request(
        it, FfiConverterString.lower(`url`),FfiConverterOptionalString.lower(`body`),_status)
}
    }
    )
    }
    ...
    @Throws(VaneException::class)override fun `postRequest`(`url`: kotlin.String, `body`: kotlin.String?): VaneResponse {
            return FfiConverterTypeVaneResponse.lift(
    callWithPointer {
    uniffiRustCallWithError(VaneException) { _status ->
    ...
    @Throws(VaneException::class)override fun `putRequest`(`url`: kotlin.String, `body`: kotlin.String?): VaneResponse {
            return FfiConverterTypeVaneResponse.lift(
    callWithPointer {
    uniffiRustCallWithError(VaneException) { _status ->
...
public object FfiConverterTypeVaneClient: FfiConverter<VaneClient, Pointer> {
    ...
    override fun lift(value: Pointer): VaneClient {
        return VaneClient(value)
    }
...
sealed class VaneException(message: String): kotlin.Exception(message) {
        
        class Generic(message: String) : VaneException(message)
...
public object FfiConverterTypeVaneError : FfiConverterRustBuffer<VaneException> {
    override fun read(buf: ByteBuffer): VaneException {
            ...
            1 -> VaneException.Generic(FfiConverterString.read(buf))
...
public object FfiConverterMapStringString: FfiConverterRustBuffer<Map<kotlin.String, kotlin.String>> {
    ...
    @Throws(VaneException::class) fun `createJsonBody`(`jsonString`: kotlin.String): kotlin.String {
            return FfiConverterString.lift(
    uniffiRustCallWithError(VaneException) { _status ->
    UniffiLib.INSTANCE.uniffi_vane_fn_func_create_json_body(
    ...
    @Throws(VaneException::class) fun `parseJsonResponse`(`response`: VaneResponse): kotlin.String {
            return FfiConverterString.lift(
    uniffiRustCallWithError(VaneException) { _status ->
    UniffiLib.INSTANCE.uniffi_vane_fn_func_parse_json_response(
        FfiConverterTypeVaneResponse.lower(`response`),_status)
}
    )
    }
